function generateProtocol(child, pastSessions) {
    ...
    const blocks = ['toy', 'orange', 'crayon'];
    const shuffledBlocks = shuffle(blocks);
    console.log('Block order:', shuffledBlocks);
    ...
    if (condition === 'surprising') {
        return {
            frames: {
                ...
                // Block-specific frames - defined dynamically for each block
                ...shuffledBlocks.reduce((acc, block) => ({
                    ...acc,
                    [`${block}-display`]: {
                        ...
                        'baseDir': 'https://raw.githubusercontent.com/sociallearninglab/self-surprise-lookit-private/main',
                        'audio': condition === 'surprising' ? 'click_to_continue' : 'cards_outro',
                        'audioTypes': ['mp3'],
                        'parentTextBlock': {
                    ...
                    [`${block}-rating`]: {
                        ...
                        'generateProperties': `function(expData, sequence, child, pastSessions) {
                            let images = [
                                {
                                    id: "not_surprised",
                                    src: "surprise_scale_not_surprised.png",
                                    left: 20,
                                    top: 50,
                                    width: 15,
                                    height: 35,
                                    correct: true,
                                    feedbackAudio: "not_surprised"
                                },
                                {
                                    id: "little_surprised",
                                    src: "surprise_scale_a_little_surprised.png",
                                    left: 35,
                                    top: 50,
                                    width: 15,
                                    height: 35,
                                    correct: true,
                                    feedbackAudio: "little_surprised"
                                },
                                {
                                    id: "sorta_surprised",
                                    src: "surprise_scale_sorta_surprised.png",
                                    left: 50,
                                    top: 50,
                                    width: 15,
                                    height: 35,
                                    correct: true,
                                    feedbackAudio: "sorta_surprised"
                                },
                                {
                                    id: "very_surprised",
                                    src: "surprise_scale_very_surprised.png",
                                    left: 65,
                                    top: 50,
                                    width: 15,
                                    height: 35,
                                    correct: true,
                                    feedbackAudio: "very_surprised"
                                }
                            ];
            ...
            // Define the sequence using the shuffled blocks
            sequence: [
                // Initial sequence
                'welcome',
                'video-config',
        ...
        return {
            frames: {
                ...
                // Block-specific frames with 4 surprise ratings
            ...shuffledBlocks.reduce((acc, block) => ({
                ...acc,
                [`${block}-unsurprising`]: {
                    'kind': 'exp-lookit-images-audio',
                    'generateProperties': `function(expData, sequence, child, pastSessions) {
                        ...
                        // Add rating scale images - now with 4 options
                        const ratingWidth = 20;
                        const ratingHeight = 35;
                        const ratingY = 50;
                        const spacing = 8;  // Reduced spacing to fit 4 options
                        const startX = (100 - (4 * ratingWidth + 3 * spacing)) / 2;  // Adjusted for 4 options
                        ...
                        images.push({
                            id: "little_surprised",
                            src: "surprise_scale_a_little_surprised.png",
                            left: startX + ratingWidth + spacing,
                            top: ratingY,
                            width: ratingWidth,
                            height: ratingHeight,
                            correct: true,
                        ...
                        images.push({
                            id: "sorta_surprised",
                            src: "surprise_scale_sorta_surprised.png",
                            left: startX + 2 * (ratingWidth + spacing),
                            top: ratingY,
                            width: ratingWidth,
                            height: ratingHeight,
                            correct: true,
                        ...
                        images.push({
                            id: "very_surprised",
                            src: "surprise_scale_very_surprised.png",
                            left: startX + 3 * (ratingWidth + spacing),
                            top: ratingY,
                            width: ratingWidth,
                            height: ratingHeight,
                            correct: true,
                ...
                [`${block}-surprising`]: {
                    // Copy of the unsurprising frame but with different audio
                    'kind': 'exp-lookit-images-audio',
                    'generateProperties': `function(expData, sequence, child, pastSessions) {
                        let images = [
                            {
            ...
            sequence: [
                // Same sequence structure as surprising condition
                'welcome',
                'video-config',
                'video-consent',
                'positioning',
